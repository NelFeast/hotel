<script setup>
import { IconMenu, IconMenu2 } from "@tabler/icons-vue";
</script>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu">
                <div class="app-brand demo">
                    ...
                    >
                        <i
                            class="icon-base ti menu-toggle-icon d-none d-xl-block"
                        ></i>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item active">
                        <a href="index.html" class="menu-link">
                            <i
                                class="menu-icon icon-base ti tabler-smart-home"
                            ></i>
                    ...
                    <li class="menu-item">
                        <a href="page-2.html" class="menu-link">
                            <i
                                class="menu-icon icon-base ti tabler-app-window"
                            ></i>
                    ...
                    >
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item dropdown me-2 me-xl-0">
                                ...
                                >
                                    <i
                                        class="icon-base ti tabler-sun icon-md theme-icon-active"
                                    ></i>
                                    <span
                                        class="d-none ms-2"
                                        id="nav-theme-text"
                                ...
                                >
                                    <li>
                                        ...
                                        >
                                            <span
                                                ><i
                                                    class="icon-base ti tabler-sun icon-md me-3"
                                                    data-icon="sun"
                                                ></i
                                                >Light</span
                                            >
                        ...
                        >
                            ...
                            >
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <div
                                            class="dropdown-divider my-1 mx-n2"
                                        ></div>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="#">
                                            <i
                                                class="icon-base ti tabler-user icon-md me-3"
                                            ></i
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="#">
                                            <i
                                                class="icon-base ti tabler-settings icon-md me-3"
                                            ></i
                                            ><span>Settings</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="#">
                                            ...
                                            >
                                                <i
                                                    class="flex-shrink-0 icon-base ti tabler-credit-card icon-md me-3"
                                                ></i
                                                ><span
                                    ...
                                    <li>
                                        ...
                                        >
                                            <i
                                                class="icon-base ti tabler-power icon-md me-3"
                                            ></i
                                            ><span>Log Out</span>
                                        </a>
                                    </li>
